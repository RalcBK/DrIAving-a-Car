...
public class NNet : MonoBehaviour
{
    ...
    public NNet InitialiseCopy (int hiddenLayerCount, int hiddenNueronCount)
    {
        NNet n = new NNet();
        ...
        n.InitialiseHidden(hiddenLayerCount, hiddenNueronCount);

        return n;
    }

    public void InitialiseHidden(int hiddenLayerCount, int hiddenNueronCount)
    {
        inputLayer.Clear();
        hiddenLayers.Clear();
        outputLayer.Clear();
        ...
        for (int i = 0; i < hiddenLayerCount+1; i++)
        {
            Matrix<float> newHiddenLayer = Matrix<float>.Build.Dense(1, hiddenNueronCount);
